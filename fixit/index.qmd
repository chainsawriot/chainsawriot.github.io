...
* Independent variable: "Toxicity" (Automatically classified by Google Perspective API)
* F1 = 0.79 (misclassification)
...
**Q: Is misclassication *really* a threat to validity?**

## Notation I

* **Y** Dependent variable
* **X** ("Toxicity"), **Z** (Likes) Independent variables
* **W** (Proxy) Automatic classifications of either **X** or **Y**
...
## Q: Are we the first one to diagnose the problem?
...
## Q: Are we the first one to fix the problem?

. . .

Use some ground truth data (e.g. manual annotations) to correct for misclassications

* **Correction by missing data imputation (MI)** - X / Y (Blackwell, Honaker, and King, 2017) 

* **Regression Calibration via Generalized Method of Moments (GMM)** - X Only (Fong & Tyler, 2021) 
...
## Q: Do you have a method that works in all situations?
...
Show only the following setup

* N = 10,000
* Only 200 ground truth data
* 73% accuracy

More simulations in the paper
...
`[Insert a picture of Bob the Builder here, but can't due to lack of copyright clearance] `
...
* Let's fix it by our versatile method: MLA
