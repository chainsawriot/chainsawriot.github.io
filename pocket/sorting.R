...
colnames(pocket) <- c("origin", "notes", "incl", "daterel", "datestart", "dateend", "org", "sponsor", "responserate", "weighted", "samplesize", "age60", "age50", "question", "support", "against", "midDate")
