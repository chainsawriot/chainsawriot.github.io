...
**Example:** Worlds of Journalism *survey* (random sample of journalists in each country)

**Personal-level:**

1. ppa: Perceived Professional Autonomy
2. EXPRNCE: Experience

**Country-level:**

1. eiu: democracy performance

```r
lmer4(ppa ~ EXPRNCE + I(eiu^3) + (1|COUNTRY), 
data = wjs)
```
